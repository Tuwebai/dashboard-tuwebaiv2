-- Script simplificado para crear tablas de estadísticas de landing page
...
-- Insertar encuestas de satisfacción de ejemplo (sin user_id para evitar errores de FK)
INSERT INTO satisfaction_surveys (company_name, rating, is_satisfied, feedback) VALUES 
