    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-background via-background/95 to-background/90 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-all duration-300">
      <div className="flex-1 overflow-hidden w-full">
           <div className="h-full w-full">
                           ...
                           {/* Header con Saludo Personalizado para Admin */}
              <div className="px-3 sm:px-4 lg:px-8 py-3 sm:py-4">
                <div className="bg-gradient-to-r from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-slate-800 dark:via-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 sm:p-8 shadow-lg border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 rounded-2xl flex items-center justify-center shadow-lg">
                      ...
                      <div>
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 dark:text-white">
                          ...
                          <span className="block sm:inline sm:ml-2 text-lg sm:text-xl lg:text-2xl font-semibold text-slate-600 dark:text-slate-300">
                            {(() => {
                              const hour = new Date().getHours();
                              if (hour >= 5 && hour < 12) return '¡Buenos días de gestión!';
                              if (hour >= 12 && hour < 18) return '¡Buenas tardes de productividad!';
                              if (hour >= 18 && hour < 22) return '¡Buenas tardes de eficiencia!';
                              return '¡Buenas noches de control!';
                            })()}
                          </span>
                        </h1>
                        <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 mt-1 flex items-center">
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="text-right">
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          {usuariosActivos} usuarios • {proyectosTotales} proyectos
                        </p>
                      </div>
              ...
              {/* Botón de Acciones Rápidas para Admin */}
              <div className="px-3 sm:px-4 lg:px-8 py-3 sm:py-4">
                <div className="flex justify-start">
                  <Button
                    ...
                    className="bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 hover:from-blue-600 hover:to-purple-800 text-white font-semibold px-4 sm:px-6 lg:px-8 py-3 sm:py-4 shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base lg:text-lg"
                  >
                    <Users className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 mr-2 sm:mr-3" />
