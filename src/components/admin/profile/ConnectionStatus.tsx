    ...
    switch (provider) {
      case 'github':
        return {
          name: 'GitHub',
          icon: (
            <svg height="16" aria-hidden="true" viewBox="0 0 24 24" version="1.1" width="16" data-view-component="true" className="octicon octicon-mark-github v-align-middle text-white">
